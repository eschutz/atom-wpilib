...
const GRADLERIO_URI = {
  java: `github.com/wpilibsuite/GradleRIO/releases/latest/download/${getConfig('gradlerioVersion')}/java.zip`,
  cpp: `github.com/wpilibsuite/GradleRIO/releases/latest/download/${getConfig('gradlerioVersion')}/cpp.zip`
}
